...
function CreateComment(props) {
    ...
    const handleSave = () => {
        props.createComment(state, story);
        handleClose();
    }
    return(
        <Fragment>
            <IconButton aria-label="comment" title="Komentari" onClick={handleClick}>
...
const mapDispatchToProps = (dispatch) => {
    return {
        createComment: (comment, story) => dispatch(createComment(comment, story))
    }
}
